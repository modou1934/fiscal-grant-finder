          ...
          <Card className="shadow-2xl border-0 hover-lift">
            <CardHeader className="text-center space-y-4">
              ...
              <CardTitle className="text-2xl font-bold text-brand-navy">
                Benvenuto in GrantFinder
              </CardTitle>
              <CardDescription className="text-base text-gray-600">
                Accedi con il tuo account Google per iniziare a trovare i bandi perfetti per la tua azienda
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-6">
              <Button 
                ...
                className="w-full bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 py-3 text-base font-medium"
              >
                {isSigningIn ? (
                  <div className="flex items-center justify-center">
                    <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-brand-navy mr-3"></div>
                    Accesso in corso...
                  </div>
                ) : (
                  <>
              ...
              <div className="text-center">
                <p className="text-xs text-gray-500 leading-relaxed">
                  ...
                  <a href="#" className="text-brand-navy hover:underline">Termini di Servizio</a>{' '}
                  e la nostra{' '}
