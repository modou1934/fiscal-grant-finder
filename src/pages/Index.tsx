...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-primary via-blue-600 to-brand-secondary">
      {/* Mobile Header */}
      <header className="safe-area-top px-4 py-3 w-full">
        <nav className="flex items-center justify-between">
          ...
          <Button 
            ...
            className="text-white hover:bg-white/10 border border-white/20 rounded-full px-3 sm:px-4 text-sm sm:text-base"
          >
            Accedi
          </Button>
        </nav>
      ...
      <section className="px-4 py-6 sm:py-8 text-center">
        <div className="max-w-sm sm:max-w-md mx-auto">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold mb-4 leading-tight text-white">
            Trova i <span className="text-brand-secondary">bandi perfetti</span> per la tua azienda
          </h1>
          ...
          <div className="space-y-3 mb-8">
            <Button 
              ...
              className="w-full bg-white text-brand-primary hover:bg-gray-100 font-semibold py-3 sm:py-4 rounded-xl shadow-lg text-sm sm:text-base"
            >
      ...
      <section className="px-4 py-6 sm:py-8 bg-white/5 backdrop-blur-sm">
        <div className="max-w-sm sm:max-w-2xl mx-auto">
          ...
          <div className="space-y-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:space-y-0">
            <Card className="bg-white/10 backdrop-blur-sm border-white/20 text-white">
              <CardContent className="p-3 sm:p-4">
                <div className="flex items-start space-x-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-brand-primary rounded-xl flex items-center justify-center flex-shrink-0">
                    <Target className="w-6 h-6 text-white" />
                  </div>
                  <div>
                    <h3 className="text-sm sm:text-base font-semibold mb-1">1. Profila la tua azienda</h3>
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-white/20 text-white">
              <CardContent className="p-3 sm:p-4">
                <div className="flex items-start space-x-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-brand-secondary rounded-xl flex items-center justify-center flex-shrink-0">
                    <Search className="w-6 h-6 text-white" />
                  </div>
                  <div>
                    <h3 className="text-sm sm:text-base font-semibold mb-1">2. Ricerca intelligente</h3>
                    <p className="text-xs sm:text-sm text-blue-100">
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-white/20 text-white">
              <CardContent className="p-3 sm:p-4">
                <div className="flex items-start space-x-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-brand-accent rounded-xl flex items-center justify-center flex-shrink-0">
                    <Bell className="w-6 h-6 text-white" />
                  </div>
                  <div>
                    <h3 className="text-sm sm:text-base font-semibold mb-1">3. Ricevi notifiche</h3>
                    <p className="text-xs sm:text-sm text-blue-100">
            ...
            {[
              ...
              <Card key={index} className="bg-white/10 backdrop-blur-sm border-white/20">
                <CardContent className="p-3 sm:p-4 text-center">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-brand-primary/20 rounded-xl flex items-center justify-center mx-auto mb-2 text-white">
                    {feature.icon}
                  </div>
                  <h3 className="text-xs sm:text-sm font-semibold mb-1 text-white">{feature.title}</h3>
